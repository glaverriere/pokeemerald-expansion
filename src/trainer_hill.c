...
static const u16 sPrizeListRoar[]        = {ITEM_TM_PIN_MISSILE,          ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const u16 sPrizeListAttract[]     = {ITEM_TM_WILL_O_WISP,       ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
