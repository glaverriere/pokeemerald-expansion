...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_CALVIN] = REMATCH(TRAINER_MIAWLO, TRAINER_CALVIN_2, TRAINER_CALVIN_3, TRAINER_CALVIN_4, TRAINER_CALVIN_5, ROUTE102),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_TYLER, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MT_PYRE_3F),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_RONNIE, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
...
{
    CreateMaleMon(&gEnemyParty[0], SPECIES_GROWLITHE_HISUI, 5);
    LockPlayerFieldControls();
